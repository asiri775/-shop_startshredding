<?php $__env->startSection('title','Service Agreement'); ?>
                ...
                <div class="client-info sm-m-b-3">
                    ...
                    <div class="row clearfix mb-1 sm-p-0 mt-4">
                        <div class="col-md-6">
                          <div class="form-group form-group-default required">
                            ...
                            <input type="text" class="form-control" name="companyName" placeholder="Company Name" required="" value="<?php echo e($serviceAgreement->company_name); ?>">
                           </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group form-group-default required">
                            <label>Contact Name</label>
                            <input type="text" class="form-control" name="contactName" placeholder="Contact Name" required="" value="<?php echo e($serviceAgreement->contact_name); ?>">
                           </div>
                        </div>
                      </div>  
                     <div class="row clearfix mb-2">
                      <div class="col-md-6">
                        <div class="form-group form-group-default required">
                          <label>Phone</label>
                          <input id="phone" type="tel" pattern="\d{3}\-\d{3}\-\d{4}" class="form-control telephone" data-mask="(999)-999-9999" placeholder="(999)-999-9999" required="" value="<?php echo e($serviceAgreement->phone_number); ?>">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group form-group-default">
                          <label>Email</label>
                          <input type="email" class="form-control" name="email" placeholder="joan@lifeforcephysio.com" value="<?php echo e($serviceAgreement->email); ?>">
                        </div>
                      </div>
                    </div>
                   ...
                   <div class="row clearfix mb-1">
                      <div class="col-md-6">
                        <div class="form-group form-group-default required">
                          ...
                          <input type="text" class="form-control" name="firstName" placeholder="577" required="" value="<?php echo e($serviceAgreement->billing_address_1); ?>">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group form-group-default">
                          <label>Addresss Line 2</label>
                          <input type="text" class="form-control" name="lastName" placeholder="Burnhamthorpe Road" value="<?php echo e($serviceAgreement->billing_address_2); ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row clearfix mb-1">
                      <div class="col-md-4">
                        <div class="form-group form-group-default required">
                          <label>City</label>
                          <input type="text" class="form-control" name="city" placeholder="Toronto" required="" value="<?php echo e($serviceAgreement->billing_city); ?>">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group form-group-default">
                          <label>State/Province/Region</label>
                          <input type="text" class="form-control" name="state" placeholder="Ontario" value="<?php echo e($serviceAgreement->billing_state); ?>">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group form-group-default required">
                          <label>Postal Code</label>
                          <input type="text" class="form-control" name="postal" placeholder="M9C 2Y3" required="" value="<?php echo e($serviceAgreement->billing_phone); ?>">
                        </div>
                      </div>
                    </div>
                  <div class="row clearfix mb-2">
                    <div class="col-md-6">
                      <div class="form-group form-group-default required">
                        <label>Phone</label>
                        <input type="text" class="form-control" name="phoneNumber" id="phoneNumber2" value="" placeholder="(999)-999-9999" value="<?php echo e($serviceAgreement->billing_phone); ?>">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group form-group-default">
                        <label>Email</label>
                        <input type="email" class="form-control" name="email" placeholder="joan@lifeforcephysio.com" value="<?php echo e($serviceAgreement->billing_email); ?>">
                      </div>
                    </div>
                  </div>
                  <div class="serv-check justify-content-between d-inline-flex w-100">
                    ...
                    <div class="row clearfix mb-1">
                      <div class="col-md-6">
                        <div class="form-group form-group-default required">
                          <label>Addresss Line 1</label>
                          <input type="text" class="form-control" name="firstName" placeholder="577" required="" value="<?php echo e($serviceAgreement->shipping_address_1); ?>">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group form-group-default">
                          <label>Addresss Line 2</label>
                          <input type="text" class="form-control" name="lastName" placeholder="Burnhamthorpe Road" value="<?php echo e($serviceAgreement->shipping_address_2); ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row clearfix mb-1">
                      <div class="col-md-4">
                        <div class="form-group form-group-default required">
                          <label>City</label>
                          <input type="text" class="form-control" name="city" placeholder="Toronto" required="" value="<?php echo e($serviceAgreement->shipping_city); ?>">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group form-group-default">
                          <label>State/Province/Region</label>
                          <input type="text" class="form-control" name="state" placeholder="Ontario" value="<?php echo e($serviceAgreement->shipping_state); ?>">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group form-group-default required">
                          <label>Postal Code</label>
                          <input type="text" class="form-control" name="postal" placeholder="M9C 2Y3" required="" value="<?php echo e($serviceAgreement->shipping_postal_code); ?>">
                        </div>
                      </div>
                    </div>
                  <div class="row clearfix mb-5">
                    <div class="col-md-6">
                      <div class="form-group form-group-default required">
                        <label>Phone</label>
                        <input type="text" class="form-control" name="phoneNumber" id="phoneNumber3" value="" placeholder="(999)-999-9999" value="<?php echo e($serviceAgreement->shipping_phone); ?>">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group form-group-default">
                        <label>Email</label>
                        <input type="email" class="form-control" name="email" placeholder="joan@lifeforcephysio.com" value="<?php echo e($serviceAgreement->shipping_email); ?>">
                      </div>
                    </div>
                  </div>
                </div>
                       ...
                       <div class="table-responsive table-orderinfo">
                          <table class="table borderless no-margin">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td class="text-center"><?php echo e($orderDetails->quantity); ?></td>
                                <td class="text-center"><?php echo e($productDetail->title); ?></td>
                                <td class="text-center">
                                  <?php echo e($settings[0]->currency_sign); ?> <?php echo e(number_format((float)$orderDetails->cost, 2, '.', '')); ?>

                                </td>
                                <td class="text-left">
                                  <?php echo e($settings[0]->currency_sign); ?><?php echo e(number_format((float)$orderDetails->cost * $orderDetails->quantity, 2, '.', '')); ?>
                              ...
                              <tr>
                                ...
                                <td class="text-left bold"><?php echo e($settings[0]->currency_sign); ?><?php echo e(number_format((float)$order->subtotal, 2, '.', '')); ?></td>
                              </tr>
                              <tr>
                                <td class="text-center" colspan="2"></td>
                                <td class="text-right">HST(13%)</td>
                                <td class="text-left"><?php echo e($settings[0]->currency_sign); ?><?php echo e(number_format((float)$order->tax, 2, '.', '')); ?></td>
                              </tr>
                              <tr>
                                ...
                                <td class="text-left">
                                  <div class="input-group">
                                    ...
                                    <input type="number" min="0" step="0.01" value="<?php echo e(number_format((float)$order->make_it_count, 2, '.', '')); ?>" class="form-control">
                                </div>
                                </td>
                              </tr>
                              <tr>
