<?php $__env->startSection('content'); ?>
    ...
    <div class="page-title row">
        <h2>Template: <?php echo e($template->name); ?></h2>
    </div>
    ...
    <div class="bg-white row">
        <div class="panel-body-custom tableContainParent panel col-md-12 col-lg-12 col-sm-12 left-tab">
                                   ...
                                   <label>Job Type</label>
                                        <select class="form-control" name="jobType" style="width: 100%;">
                                            ...
                                            <?php foreach ($jobType as $type) { ?>
                                                <option value="<?php echo e($type->id); ?>" <?php if($_GET['jobType']==$type->id): ?> selected <?php endif; ?>>
                                    ...
                                    <div class="col-md-2 col-xs-12">
                                        ...
                                        <select class="form-control" name="orderType" style="width: 100%;">
                                            ...
                                            <option value="1" <?php if($_GET['orderType']==1): ?> selected <?php endif; ?>>WALK IN</option>
                                            <option value="2" <?php if($_GET['orderType']==2): ?> selected <?php endif; ?>>ONLINE</option>
                                            <option value="3" <?php if($_GET['orderType']==3): ?> selected <?php endif; ?>>REPEAT</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
            ...
            <a href="/vendor/order-template/<?php echo e($template->id); ?>" class="btn btn-success float-right my-2">Back To Template</a>
        </div>
    </div>
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#orders-table').DataTable({
                ...
                ajax: {
                    url: '<?php echo e(url('vendor/get-template-history-ajax')); ?>/<?php echo e($template->client_id); ?>/<?php echo e($template->id); ?>?orderId=' + orderId + '&quickdate=' + quickDate + '&fromTime=' + fromTime + '&toTime=' + toTime + '&status=' + status+ '&jobName==' + jobName + '&jobType==' + jobType + '&orderType==' + orderType+ '&orderForm=Search',
                },
                columns: [
                    {
                        'targets': 0,
                    ...
                    'selectNone',
                    {
                        ...
                        action: function (e, dt, node, config) {
                            ...
                            if (confirmdelete == true) {
                                ...
                                $.ajax({
                                    url: '<?php echo e(url('/vendor/get-template-order-delete')); ?>/<?php echo e($template->client_id); ?>',
                                    type: 'POST',
    ...
    <div id="sendAll" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <br>
                    <h5><?php echo e(__('Send receipts via email to the address below')); ?></h5>
                    <input type="text" placeholder="email@domain.com" class="form-control" name="send_email">
