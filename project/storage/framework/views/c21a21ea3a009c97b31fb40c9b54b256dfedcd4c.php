...
<!-- BEGIN VENDOR JS -->
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/pace/pace.min.js')); ?>"  type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery/jquery-3.2.1.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/modernizr.custom.js')); ?>"  type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-ui/jquery-ui.min.js')); ?>"  type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/popper/umd/popper.min.js')); ?>"  type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/bootstrap/js/bootstrap.min.js')); ?>"  type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery/jquery-easy.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-unveil/jquery.unveil.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-ios-list/jquery.ioslist.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-actual/jquery.actual.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-scrollbar/jquery.scrollbar.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/select2/js/select2.full.min.js')); ?>" type="text/javascript" src=""></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/classie/classie.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/switchery/js/switchery.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/nvd3/lib/d3.v3.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/nvd3/nv.d3.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/nvd3/src/utils.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/nvd3/src/tooltip.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/nvd3/src/interactiveLayer.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/nvd3/src/models/axis.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/nvd3/src/models/line.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/nvd3/src/models/lineWithFocusChart.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/mapplic/js/hammer.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/mapplic/js/jquery.mousewheel.js')); ?>"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/mapplic/js/mapplic.js')); ?>"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/rickshaw/rickshaw.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-metrojs/MetroJs.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-sparkline/jquery.sparkline.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/skycons/skycons.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-datatable/media/js/jquery.dataTables.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-datatable/extensions/TableTools/js/dataTables.tableTools.min.js')); ?>"
    type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-datatable/media/js/dataTables.bootstrap.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/jquery-datatable/extensions/Bootstrap/jquery-datatable-bootstrap.js')); ?>"
    type="text/javascript"></script>
<script src="<?php echo e(URL::asset('new_assets/assets/plugins/datatables-responsive/js/datatables.responsive.js')); ?>" type="text/javascript"></script>
<!-- END VENDOR JS -->
<!-- BEGIN CORE TEMPLATE JS -->
<!-- BEGIN CORE TEMPLATE JS -->
<script src="<?php echo e(URL::asset('new_assets/pages/js/pages.js')); ?>"></script>
<!-- END CORE TEMPLATE JS -->
<!-- BEGIN PAGE LEVEL JS -->
<script src="<?php echo e(URL::asset('new_assets/assets/js/scripts.js')); ?>" type="text/javascript"></script>
<!-- END PAGE LEVEL JS -->
<!-- END CORE TEMPLATE JS -->
<!-- BEGIN PAGE LEVEL JS -->
